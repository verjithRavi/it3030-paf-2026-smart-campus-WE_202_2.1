      ...
      <div className="rounded-3xl border border-slate-100 bg-white/95 p-8 shadow-[0_16px_40px_rgba(15,23,42,0.08)]">
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <h2 className="text-2xl font-semibold text-slate-900">Ticket Management</h2>
          </div>
              ...
              <div className="mt-3 grid gap-3 md:grid-cols-3">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <button
                      onClick={() =>
                        handleResolve(ticket.id, actionState[`notes-${ticket.id}`] || '')
                      }
                    ...
                    <button
                      onClick={() =>
                        handleReject(ticket.id, actionState[`notes-${ticket.id}`] || '')
                      }
